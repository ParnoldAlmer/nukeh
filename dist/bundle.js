...
For more options: man nmap`;
    ...
    if (target.includes("192.168.") || target.includes("10.0.") || target.includes("172.16.") || target.includes(".nukeh.") || target.includes(".internal") || target.includes(".mil") || target.includes(".lab") || target === "localhost") {
